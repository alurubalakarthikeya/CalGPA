...
function calculatePercentage(event) {
  ...
  if (!isNaN(obtainedMarks) && !isNaN(totalMarks) && totalMarks > 0) {
      ...
      switch (subjectName.toLowerCase()) {
          case 'dld':
            infoText = 'Digital Logic Design is vital for developing circuits used in computers, mobile phones, and modern electronics. Key skills include proficiency in Boolean algebra, circuit simulation, and hardware description languages like Verilog or VHDL. Common job roles are Digital Design Engineer and VLSI Engineer, offering salaries averaging ₹6–10 LPA in India, with experienced professionals earning up to ₹25 LPA. Global salaries range from $70,000 to $120,000 annually, depending on skills and location.';
              suggestionsText = 'To excel in Digital Logic Design, focus on understanding the basics of logic gates, truth tables, and Boolean algebra. Practice designing simple circuits and progress to combinational and sequential circuits. Review past problems and simulate circuits using tools like Logisim.<br><br>Resources:<br><a href="https://www.coursera.org/learn/digital-circuits" style="text-decoration: none; color: #0b1f18">Coursera Digital Circuits <i class="fa-solid fa-arrow-up-right-from-square"></i></a><br><a href="https://www.khanacademy.org/computing/computer-science/algorithms" style="text-decoration: none; color: #0b1f18">Khan Academy Algorithms <i class="fa-solid fa-arrow-up-right-from-square"></i></a><br><a href="https://www.tutorialspoint.com/digital_circuits/index.htm" style="text-decoration: none; color: #0b1f18">TutorialsPoint Digital Circuits <i class="fa-solid fa-arrow-up-right-from-square"></i></a>.';
              break;
          case 'fsd':
              ...
              suggestionsText = 'To improve in Full Stack Development, practice building projects that involve both front-end and back-end technologies. Learn popular frameworks like React, Angular, Node.js, and Django.<br><br> Useful resources: <br><a href="https://www.freecodecamp.org/" style="text-decoration: none; color: #0b1f18">FreeCodeCamp <i class="fa-solid fa-arrow-up-right-from-square"></i></a>,<br> <a href="https://www.udemy.com/course/the-complete-web-developer-zero-to-mastery/" style="text-decoration: none; color: #0b1f18">Udemy Web Developer Course <i class="fa-solid fa-arrow-up-right-from-square"></i></a>.';
              break;
          case 'ds':
              ...
              suggestionsText = 'To improve in Data Structures, practice implementing different data structures like arrays, linked lists, stacks, queues, trees, and graphs. Solve problems on platforms like LeetCode and HackerRank.<br><br> Useful resources:<br> <a href="https://www.geeksforgeeks.org/data-structures/" style="text-decoration: none; color: #0b1f18">GeeksforGeeks Data Structures <i class="fa-solid fa-arrow-up-right-from-square"></i></a>,<br> <a href="https://www.coursera.org/specializations/data-structures-algorithms" style="text-decoration: none; color: #0b1f18">Coursera Data Structures and Algorithms<i class="fa-solid fa-arrow-up-right-from-square"></i></</a>.';
              break;
          case 'dmgt':
              ...
              suggestionsText = 'To improve in Discrete Mathematics and Graph Theory, focus on understanding the core concepts and solving related problems. Study topics like set theory, combinatorics, graph theory, and algorithms.<br> <br>Useful resources:<br> <a href="https://www.khanacademy.org/math/discrete-math" style="text-decoration: none; color: #0b1f18">Khan Academy Discrete Math <i class="fa-solid fa-arrow-up-right-from-square"></i></a>,<br> <a href="https://www.coursera.org/learn/algorithms-graphs-data-structures" style="text-decoration: none; color: #0b1f18">Coursera Graph Algorithms<i class="fa-solid fa-arrow-up-right-from-square"></i></a>.';
              break;
          case 'tnt':
              ...
              suggestionsText = 'To improve in Transform Numerical Techniques, practice solving numerical problems and understand the underlying mathematical concepts. Study topics like numerical integration, differentiation, and linear algebra.<br><br> Useful resources:<br> <a href="https://www.coursera.org/learn/numerical-methods-engineers" style="text-decoration: none; color: #0b1f18">Coursera Numerical Methods <i class="fa-solid fa-arrow-up-right-from-square"></i></a>,<br> <a href="https://ocw.mit.edu/courses/mathematics/18-335j-introduction-to-numerical-methods-spring-2019/" style="text-decoration: none; color: #0b1f18">MIT OpenCourseWare Numerical Methods <i class="fa-solid fa-arrow-up-right-from-square"></i></a>.';
              break;
          case 'java':
              ...
              suggestionsText = 'To improve in Java Development, practice writing Java programs and understand object-oriented programming concepts. Build projects using Java frameworks like Spring and Hibernate.<br><br> Useful resources: <br><a href="https://www.codecademy.com/learn/learn-java" style="text-decoration: none; color: #0b1f18">Codecademy Java <i class="fa-solid fa-arrow-up-right-from-square"></i></a>, <br><a href="https://www.udemy.com/course/java-the-complete-java-developer-course/" style="text-decoration: none; color: #0b1f18">Udemy Java Course <i class="fa-solid fa-arrow-up-right-from-square"></i></a>.';
              break;
          default:
