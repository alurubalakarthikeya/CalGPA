  ...
  if (!isNaN(obtainedMarks) && !isNaN(totalMarks) && totalMarks > 0) {
      ...
      switch (subjectName.toLowerCase()) {
          case 'dld':
              ...
              suggestionsText = 'To improve in Digital Logic Design, focus on understanding the basics of logic gates and circuits. Practice designing simple circuits and gradually move to complex ones. <br><br> Useful resources:<br> <a href="https://www.coursera.org/learn/digital-circuits">Coursera Digital Circuits</a>,<br> <a href="https://www.khanacademy.org/computing/computer-science/algorithms">Khan Academy Algorithms</a>.';
              break;
          case 'fsd':
              ...
              suggestionsText = 'To improve in Full Stack Development, practice building projects that involve both front-end and back-end technologies. Learn popular frameworks like React, Angular, Node.js, and Django.<br><br> Useful resources: <br><a href="https://www.freecodecamp.org/">FreeCodeCamp</a>,<br> <a href="https://www.udemy.com/course/the-complete-web-developer-zero-to-mastery/">Udemy Web Developer Course</a>.';
              break;
          case 'ds':
              ...
              suggestionsText = 'To improve in Data Structures, practice implementing different data structures like arrays, linked lists, stacks, queues, trees, and graphs. Solve problems on platforms like LeetCode and HackerRank.<br><br> Useful resources:<br> <a href="https://www.geeksforgeeks.org/data-structures/">GeeksforGeeks Data Structures</a>,<br> <a href="https://www.coursera.org/specializations/data-structures-algorithms">Coursera Data Structures and Algorithms</a>.';
              break;
          case 'dmgt':
          ...
          case 'tnt':
              ...
              suggestionsText = 'To improve in Transform Numerical Techniques, practice solving numerical problems and understand the underlying mathematical concepts. Study topics like numerical integration, differentiation, and linear algebra.<br><br> Useful resources:<br> <a href="https://www.coursera.org/learn/numerical-methods-engineers">Coursera Numerical Methods</a>,<br> <a href="https://ocw.mit.edu/courses/mathematics/18-335j-introduction-to-numerical-methods-spring-2019/">MIT OpenCourseWare Numerical Methods</a>.';
              break;
          case 'java':
              ...
              suggestionsText = 'To improve in Java Development, practice writing Java programs and understand object-oriented programming concepts. Build projects using Java frameworks like Spring and Hibernate.<br><br> Useful resources: <br><a href="https://www.codecademy.com/learn/learn-java">Codecademy Java</a>, <br><a href="https://www.udemy.com/course/java-the-complete-java-developer-course/">Udemy Java Course</a>.';
              break;
          default:
